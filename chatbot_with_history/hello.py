# agents with history 100% run code  tools test an add lostion
import os
...
agent1 =Agent(
    instructions="You are a helpful assistant, you can answer of user questions.use get_weather tool to share get tempreature for any location",
